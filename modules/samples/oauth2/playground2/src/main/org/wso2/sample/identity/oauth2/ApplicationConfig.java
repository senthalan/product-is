...
public class ApplicationConfig {
  ...
  public static String getSessionIframeEndpointContext() {
    String iframeURL =
        buildURL(getProperties().getProperty(SESSION_IFRAME_ENDPOINT_CONTEXT));
